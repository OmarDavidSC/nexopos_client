...
import { ReportProfitFilter } from "../models/base/ReportProfitFilter";
...
export class ReportProfitService {
    private urlBase = environment.uriApiBack + "/rprofit";
    ...
    async index(filter: ReportProfitFilter): Promise<any> {
        try {
